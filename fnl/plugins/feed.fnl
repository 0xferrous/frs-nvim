(let [root_feeds ["https://feeds.allenpike.com/feed/"
  ...
  (set (. programming_feeds :rust) rust_feeds)
  (set (. root_feeds :crypto) crypto_feeds)
  (set (. root_feeds :programming) programming_feeds)
  {1 :neo451/feed.nvim
   :cmd :Feed
   :opts {:progress {:backend :fidget} :feeds root_feeds}
   :dependencies [{1 :folke/snacks.nvim :opts {:image {:enabled true}}}]})
